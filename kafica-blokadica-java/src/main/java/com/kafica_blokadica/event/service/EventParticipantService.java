...
public class EventParticipantService {
    ...
    private boolean hasActiveVote(Long eventId, Long userId) {
        return placeVoteRepository.existsActivePlaceVote(eventId, userId)
                || timeVoteRepository.existsActiveTimeVote(eventId, userId);
    }
    ...
    public ParticipantStatusResponse getStatus(Long eventId)
    {
        ...
        long responded = participants.stream()
                .filter(p -> hasActiveVote(eventId, p.getUserId()))
                .count();
